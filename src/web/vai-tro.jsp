        ...
        <div style="padding: 10px 25px;">
            ...
            <div class="toolbar"
                ...
                <div class="search-box">
                    ...
                    <input type="text" id="txtSearchVT" class="rounded-input" placeholder="Nhập tên vai trò..."
                        onkeyup="filterVTTable()" style="width: 250px;">
                        ...
                        <c:forEach var="vt" items="${listVaiTro}">
                            <tr onclick="openVTForm('update', this.dataset)" data-id="${vt.getMaVaiTro()}"
                                ...
                                <td class="action-cell center_cell">
                                    <form id="frmDelVT_${vt.getMaVaiTro()}" action="vai-tro-data" method="post"
                                        style="display:none;">
                                    ...
                                    <button type="button" class="btn-swing btn-danger"
                                        ...
                                        onclick="event.stopPropagation(); confirmDelete('Bạn có chắc chắn muốn xóa vai trò này?', 'vaitro', this.closest('tr').dataset.id, 'frmDelVT_' + this.closest('tr').dataset.id);">Xóa</button>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
